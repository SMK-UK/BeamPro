...
# chek input image type - fitting only works for grayscale image
if Image.open(path + image_list[0]).mode != 'L':
    sys.exit('Image mode incorrect! Please use Grayscale only')
